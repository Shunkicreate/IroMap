...
- [x] T-005 分析ダッシュボードUIを実装する（FR-1,2,3,4）
  - 完了条件: 4指標を1画面で確認できる
- [x] T-006 分析結果の見方ヘルプ（値レンジと評価ラベル）を実装する（FR-6）
  - 完了条件: 各分析指標に評価基準ヘルプが表示される
...
- [x] T-105 評価基準ヘルプの表示とラベル判定を確認する（FR-6）

## 監視 / 運用

- [x] T-201 画像サイズごとの分析処理時間を記録する（NFR-1）
- [x] T-202 同一入力で再分析結果が一致することを確認する（NFR-2）
